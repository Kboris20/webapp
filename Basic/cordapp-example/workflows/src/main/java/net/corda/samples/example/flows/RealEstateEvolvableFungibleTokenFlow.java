...
public class RealEstateEvolvableFungibleTokenFlow {
    ...
    public static class CreateHouseTokenFlow extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            //create token type
            EdupointTokenState evolvableTokenType = new EdupointTokenState(valuation, getOurIdentity(),
    ...
    public static class MoveHouseTokenFlow extends FlowLogic<SignedTransaction>{
        ...
        public SignedTransaction call() throws FlowException {
            ...
            //get the RealEstateEvolvableTokenType object
            EdupointTokenState tokenstate = stateAndRef.getState().getData();

            //get the pointer pointer to the house
            TokenPointer<EdupointTokenState> tokenPointer = tokenstate.toPointer(EdupointTokenState.class);
