...
import net.corda.samples.example.contracts.EdupointTokenStateContract;
...
@BelongsToContract(EdupointTokenStateContract.class)
public class EdupointTokenState extends EvolvableTokenType {
    ...
    public EdupointTokenState(BigDecimal valuation, Party maintainer,
    ...
    public boolean equals(Object o) {
        ...
        EdupointTokenState that = (EdupointTokenState) o;
